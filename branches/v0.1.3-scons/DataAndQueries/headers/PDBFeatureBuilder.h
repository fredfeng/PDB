...
public:
	...
	// gets an empty version of this guy, which can be deserialized into
	virtual PDBFeatureBuilderPtr getEmptyBuilder () = 0;
	...
	// gets a unique code; used during deserialization
