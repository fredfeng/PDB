...
#ifndef HANDLE_DATA_FRONT_END_SERVER_WORK_H
#define HANDLE_DATA_FRONT_END_SERVER_WORK_H
...
class HandleDataAtFrontEndServerWork : public PDBCommWork {
...
public:
	...
	HandleDataAtFrontEndServerWork (string pathOfBackendIn);
