...
#ifndef HANDLE_QUERY_FRONT_END_SERVER_WORK_H
#define HANDLE_QUERY_FRONT_END_SERVER_WORK_H
...
// this is a class that encapsultes the protocol for accepting a query from a client
class HandleQueryAtFrontEndServerWork : public PDBCommWork {
...
public:
	...
	// socket enabling communication with the backend, as well as the deserialization
	// machine that should be used to deserialize queries
	HandleQueryAtFrontEndServerWork (string pathOfBackendIn);
