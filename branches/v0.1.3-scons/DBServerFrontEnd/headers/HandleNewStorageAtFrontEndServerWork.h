...
#ifndef HANDLE_STORAGE_FRONT_END_SERVER_WORK_H
#define HANDLE_STORAGE_FRONT_END_SERVER_WORK_H
...
// this is a class that encapsultes the protocol for accepting a new storage location request from a client
class HandleNewStorageAtFrontEndServerWork : public PDBCommWork {
...
public:
	...
	// from the interface; returns a linked HandleNewStorageAtFrontEndServerWorkBuzzer object
	...
	HandleNewStorageAtFrontEndServerWork (string pathOfBackendIn);
