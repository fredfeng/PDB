...
void BuildMakefile (const char *makefileName, const char *prelude, const char *headerIncludeDirectories,
        ...
        if (filesToBuildDependenciesFor != 0 && dependencyFile != 0) {
                ...
                while (GetLine (buffer, temp)) {
                        ...
                        fprintf (suffix, "\t$(CC) $(INCLUDE) -M %s >> %s.dep\n", buffer, buffer);
        ...
        if (m4FilesForHeaders != 0 || m4FilesForCPlusPlus != 0 || filesToBuildDependenciesFor != 0) {
...
int main (int numArgs, char **args) {
        ...
        BuildMakefile ("Makefile", args[2], 0, "M4IncludeDirectories",
