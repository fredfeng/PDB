...
public:
	...
	string getErrorMessage ();
        ...
        // copy from another PDBQueryResultSet object
        PDBQueryResultSet (const PDBQueryResultSet &fromMe);

	// an empty set
	PDBQueryResultSet ();

        // assignment of PDBQueryResultSet objects
        PDBQueryResultSet &operator = (const PDBQueryResultSet &other);
	...
	void wasAnError (string errorMessage);
